...
<div class="mainBlock">
  <h1>Welcome to  ProjectShopping v<?php echo osc_get_version(); ?>!</h1>

  <p>ProjectShopping Online Merchant helps you sell products worldwide with your own online store. Its Administration Tool manages products, customers, orders, newsletters, specials, and more to successfully build the success of your online business.</p>
  <p>ProjectShopping Developed by Ashish Gautam</p>
</div>
