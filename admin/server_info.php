...
*/
  ...
  switch ($action) {
    ...
    case 'submit':
      $target_host = 'usage.ProjectShopping
.com';
...
<?php
    ...
    echo '<table border="1" cellpadding="3" width="600" style="border: 0px; border-color: #000000;">' .
         '  <tr><td><a href="http://www.ProjectShopping
.com"><img border="0" src="images/ProjectShopping
.png" title="ProjectShopping
 Online Merchant v' . tep_get_version() . '" /></a><h1 class="p">ProjectShopping
 Online Merchant v' . tep_get_version() . '</h1></td>' .
         '  </tr>' .
         '</table>';
    echo $regs[1];
  } else {
