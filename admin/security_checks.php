...
<?php
  foreach ($modules as $module) {
    ...
    echo '  <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">' . "\n" .
         ...
         '    <td class="dataTableContent" align="center" valign="top">' . ((isset($secCheck->has_doc) && $secCheck->has_doc) ? '<a href="http://library.ProjectShopping
.com/Wiki&oscom_2_3&security_checks&' . $module['code'] . '" target="_blank">' . tep_image(DIR_WS_IMAGES . 'icons/preview.gif') . '</a>' : '') . '</td>' . "\n" .
         '  </tr>' . "\n";
  }
?>
