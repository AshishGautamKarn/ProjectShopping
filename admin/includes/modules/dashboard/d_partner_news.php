...
.com/Services" target="_blank">' . MODULE_ADMIN_DASHBOARD_PARTNER_NEWS_MORE_TITLE . '</a></td>' .
                   '  </tr>' .
                   '</table>';
      }
    ...
    function _getContent() {
      ...
      $filename = DIR_FS_CACHE . 'ProjectShopping
_partners_news.cache';
      ...
      if ( !isset($result) ) {
        if (function_exists('curl_init')) {
          $ch = curl_init();
          curl_setopt($ch, CURLOPT_URL, 'http://www.ProjectShopping
.com/index.php?RPC&Website&Index&GetPartnerStatusUpdates');
...
.com' . "\r\n" .
    ...
    function install() {
      tep_db_query("insert into " . TABLE_CONFIGURATION . " (configuration_title, configuration_key, configuration_value, configuration_description, configuration_group_id, sort_order, set_function, date_added) values ('Enable Partner News Module', 'MODULE_ADMIN_DASHBOARD_PARTNER_NEWS_STATUS', 'True', 'Do you want to show the latest ProjectShopping
 Partner News on the dashboard?', '6', '1', 'tep_cfg_select_option(array(\'True\', \'False\'), ', now())");
