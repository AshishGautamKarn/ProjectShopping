...
*/
  ...
  if (function_exists('curl_init')) {
    $ch = curl_init();
    curl_setopt($ch, CURLOPT_URL, 'http://www.ProjectShopping_Ashish.com/version/online_merchant/' . $major_version);
    ...
    if ($fp = @fsockopen('www.ProjectShopping.com', 80, $errno, $errstr, 30)) {
      $header = 'GET /version/online_merchant/' . $major_version . ' HTTP/1.0' . "\r\n" .
                'Host: www.ProjectShopping.com' . "\r\n" .
                'Connection: close' . "\r\n\r\n";
  ...
  if (is_array($releases) && !empty($releases)) {
    ...
    if ($f = @fopen(DIR_FS_CACHE . 'ProjectShopping_version_check.cache', 'w')) {
...
?>
    ...
    <table border="0" width="100%" cellspacing="0" cellpadding="2">
      ...
      <tr>
        <td class="smallText"><?php echo TITLE_INSTALLED_VERSION . ' <strong>ProjectShopping Online Merchant v' . $current_version . '</strong>'; ?></td>
      </tr>
      <tr>
...
?>
              <tr class="dataTableRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)">
                <td class="dataTableContent"><?php echo '<a href="' . $version[2] . '" target="_blank">ProjectShopping Online Merchant v' . $version[0] . '</a>'; ?></td>
