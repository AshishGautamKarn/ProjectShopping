...
/*
 ...
 ProjectShopping*/
  ...
  define('MODULE_PAYMENT_2CHECKOUT_TEXT_DESCRIPTION', '<img src="images/icon_popup.gif" border="0">&nbsp;<a href="https://www.2checkout.com/2co/signup?affiliate=1255821" target="_blank" style="text-decoration: underline; font-weight: bold;">Visit 2Checkout Website</a>&nbsp;<a href="javascript:toggleDivBlock(\'pm2checkoutInfo\');">(info)</a><span id="pm2checkoutInfo" style="display: none;"><br /><i>Using the above link to signup at 2Checkout grants ProjectShopping a small financial bonus for referring a customer.</i></span><br /><br />Credit Card Test Info:<br /><br />CC#: 4111111111111111<br />Expiry: Any');
