...
/*
 ...
 ProjectShopping*/
  ...
  define('MODULE_CONTENT_PAYPAL_LOGIN_DESCRIPTION', 'Enable Log In with PayPal with seamless checkout for PayPal Express Checkout payments<br /><br /><img src="images/icon_info.gif" border="0" />&nbsp;<a href="http://library.ProjectShopping.com/Package&en&paypal&oscom23&log_in" target="_blank" style="text-decoration: underline; font-weight: bold;">View Online Documentation</a><br /><br /><img src="images/icon_popup.gif" border="0">&nbsp;<a href="https://www.paypal.com" target="_blank" style="text-decoration: underline; font-weight: bold;">Visit PayPal Website</a>');
  ...
  define('MODULE_CONTENT_PAYPAL_LOGIN_ERROR_ADMIN_CURL', 'This module requires cURL to be enabled in PHP and will not load until it has been enabled on this webserver.');
  ...
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_GROUP_personal', 'Personal Information');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_GROUP_address', 'Address Information');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_GROUP_account', 'Account Information');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_GROUP_checkout', 'Checkout Express');

  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_full_name', 'Full Name');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_date_of_birth', 'Date of Birth');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_age_range', 'Age Range');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_gender', 'Gender');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_email_address', 'Email Address');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_street_address', 'Street Address');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_city', 'City');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_state', 'State');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_country', 'Country');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_zip_code', 'Zip Code');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_phone', 'Phone');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_account_status', 'Account Status (verified)');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_account_type', 'Account Type');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_account_creation_date', 'Account Creation Date');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_time_zone', 'Time Zone');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_locale', 'Locale');
  define('MODULE_CONTENT_PAYPAL_LOGIN_ATTR_language', 'Language');
  ...
  define('MODULE_CONTENT_PAYPAL_LOGIN_DIALOG_CONNECTION_SUCCESS', 'Success!');
  define('MODULE_CONTENT_PAYPAL_LOGIN_DIALOG_CONNECTION_FAILED', 'Failed! Please review the Verify SSL Certificate settings and try again.');
  define('MODULE_CONTENT_PAYPAL_LOGIN_DIALOG_CONNECTION_ERROR', 'An error occurred. Please refresh the page, review your settings, and try again.');
